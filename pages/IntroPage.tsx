  ...
  return (
    <div className="space-y-16 py-8 animate-fade-in">
      <header className="space-y-6 max-w-4xl">
        <div className="inline-block px-3 py-1 bg-blue-600/20 text-blue-500 text-[10px] font-bold uppercase tracking-[3px] rounded">Purpose</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-zinc-800">
        <div className="space-y-4">
          <h2 className="text-blue-500 font-bold uppercase tracking-widest text-xs tracking-[2px]">Focus</h2>
          <p className="text-xl font-medium text-white">Pragmatic Hiring</p>
          <p className="text-zinc-500 text-sm leading-relaxed">Taking what we have learnt from 2025 and the vision for growth to build the 2026 TA operating engine.</p>
        </div>
